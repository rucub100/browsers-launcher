const debug = require('debug')('browsers-launcher:find_system_node')
 ...
 * Note about fix-path:
 *   while fix-path is good, it can cause unexpected behavior when running browsers-launcher locally
