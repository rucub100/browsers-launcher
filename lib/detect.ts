...
export const setMajorVersion = <T extends HasVersion>(browser: T): T => {
  ...
  if (unsupportedVersion) {
    ...
    foundBrowser.warning = `browsers-launcher does not support running ${browser.displayName} version ${majorVersion}. To use ${browser.displayName} with browsers-launcher, install a version of ${browser.displayName} newer than or equal to ${browser.minSupportedVersion}.`
  }
